from src2.Plotting.plots import plot_curs_dist, plot_curs_time, plot_cur_runtime, plot_curs_dist_dual
...
'''
    ...
    plot_curs_dist_dual(R,private_R, 10, 13, 25, "./Figs2/comparison/")
